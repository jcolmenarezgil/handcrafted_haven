...
export default function LoginForm() {
  ...
  return (
    <form action="/api/auth/login" className="space-y-3">
      ...
      <div className="flex-1 rounded-3xl bg-white px-8 pb-10 pt-10 shadow-sm border border-slate-100">
        ...
        <div className="w-full space-y-6">
          ...
          <div className="group">
            <label
              className="mb-2 block text-[11px] font-bold uppercase tracking-wider text-[#6b4f3f]"
>>>>>>> beb991d1ec6d334406541e6ea9eae4fd0f9ec8f4
              htmlFor="password"
            >
              Password
            </label>
...
<<<<<<< HEAD
        ...
        <button className="mt-4 w-full bg-white-500 text-black p-2 rounded-md ">
